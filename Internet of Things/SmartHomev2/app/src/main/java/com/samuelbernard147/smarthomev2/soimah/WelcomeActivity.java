...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private TextView tvSoimah;
    private TextView tvDescSoimah;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soimah_welcome);
        ...
        tvSoimah = findViewById(R.id.tv_soimah);

        // layout xml slide 1 sampai 4
        layouts = new int[]{
                R.layout.soimah_slide1,
                R.layout.soimah_slide2,
                R.layout.soimah_slide3};
