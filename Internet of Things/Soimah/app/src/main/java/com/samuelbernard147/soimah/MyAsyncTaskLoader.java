...
public class MyAsyncTaskLoader extends AsyncTaskLoader<ArrayList<KartuItems>> {
    ...
    public MyAsyncTaskLoader(final Context context, int day, int month) {
        super(context);
        onContentChanged();
        this.day = day;
        this.month = month;
    ...
    public ArrayList<KartuItems> loadInBackground() {
        ...
        String url = "http://agriculture.hopecoding.com/api/search/riwayat?" +
                "day=" + day +
                "&month=" + month + "&author=agriculture_1";
