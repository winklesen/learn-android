...
package com.samuelbernard147.alirkan.Job;
...
import com.samuelbernard147.alirkan.R;
...
public class GetHumidityJobService extends JobService {
    ...
    //Isikan dengan nama author Anda;
...
//                int normalHumidity = 600;
                try {
                    ...
                    int currentFlush = responseObject.getInt("Jumlah_penyiraman");
                    String currentHumidity = responseObject.getString("kelembapan");

                    String title = "Alirkan";
                    String message = "Jumlah penyiraman " + currentFlush + ", kelembapan saat ini " + currentHumidity + "%";
